...
x <- paste0("this.path_2.7.1.tar", c(".gz", ".bz2", ".xz"))
names(x) <- x
ext(x, compression = TRUE) <- ".png"
stopifnot(identical(x, c(this.path_2.7.1.tar.gz = "this.path_2.7.1.png", this.path_2.7.1.tar.bz2 = "this.path_2.7.1.png", this.path_2.7.1.tar.xz = "this.path_2.7.1.png")))
