...
x <- paste0("this.path_2.7.0.tar", c(".gz", ".bz2", ".xz"))
names(x) <- x
ext(x, compression = TRUE) <- ".png"
stopifnot(identical(x, c(this.path_2.7.0.tar.gz = "this.path_2.7.0.png", this.path_2.7.0.tar.bz2 = "this.path_2.7.0.png", this.path_2.7.0.tar.xz = "this.path_2.7.0.png")))
